...
#[contract]
pub struct ShieldedTransferVerifier;

#[contractimpl]
impl ShieldedTransferVerifier {
...
mod test {
    ...
    fn test_not_initialized() {
        let env = Env::default();
        let contract_id = env.register(ShieldedTransferVerifier, ());
        let client = ShieldedTransferVerifierClient::new(&env, &contract_id);
